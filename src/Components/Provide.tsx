...
<motion.div 
    ...
    custom={3}
    className={`flex items-center h-[30px] justify-between  w-[60%] sm:w-[78%] md:w-[100%]`}>
    <div className={`w-[15px] h-[15px] bg-[green] rounded-full flex justify-between md:justify-center items-center `}><HandySvg src={svg}/></div>
    ...
    variants={lefElements} 
    custom={4} 
    className={`w-[80%] text-[0.6rem] text-start sm:w-[100%] md:w-[100%]`}>Experience A Variety Of Trading On Bitcost. You Can Use Various Types Of Coin Transactions Such As Spot Trade, Futures Trade, P2P, Staking, Mining, And Margin.</motion.p>
...
<motion.div 
    ...
    variants={lefElements} 
    custom={6}
    className={`w-[80%] text-[0.6rem] text-start sm:w-[100%] sm:mt-2 md:w-[100%]`}>Experience A Variety Of Trading On Bitcost. You Can Use Various Types Of Coin Transactions Such As Spot Trade, Futures Trade, P2P, Staking, Mining, And Margin.</motion.p>
</div>
...
<div className={`w-[40%] h-[70%] flex justify-center items-center relative sm:hidden md:h-[20%]`}>
<div className={`w-[500px] h-[360px] absolute bg-cover bg-center bg-no-repeat top-[-50%] sm:hidden md:w-[300px] md:h-[220px]`}
style={{
